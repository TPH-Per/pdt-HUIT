...
import com.example.demo.dto.request.CreateRegistrarRequest;
import com.example.demo.dto.request.UpdateProfileRequest;
import com.example.demo.dto.response.RegistrarResponse;
...
public class RegistrarController {
    ...
    public ResponseEntity<RegistrarResponse> getProfile() {
        ...
        if (auth != null && auth.getPrincipal() instanceof com.example.demo.security.CustomUserDetails) {
            Integer id = ((com.example.demo.security.CustomUserDetails) auth.getPrincipal()).getId();
            RegistrarResponse registrar = registrarService.getRegistrarById(id);
            return ResponseEntity.ok(registrar);
        }
