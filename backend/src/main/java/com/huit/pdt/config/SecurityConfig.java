...
import com.huit.pdt.domain.auth.service.RegistrarUserDetailsService;
...
public class SecurityConfig {
    ...
    private final RegistrarUserDetailsService registrarUserDetailsService;
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(
                                ...
                                "/api/student/auth/**", // Student auth endpoints (login, register)
                                "/error", // Error page
                                "/internal/actuator/health", // Health check (public)
                                "/actuator/**" // Let old actuator path return 404 from MVC layer
                        ).permitAll()

                        // Student endpoints require STUDENT role
                        .requestMatchers("/api/student/**").hasRole("STUDENT")

                        // Registrar endpoints require REGISTRAR or ADMIN role
                        ...
                        .requestMatchers("/internal/actuator/**").authenticated()

                        // Tất cả URLs còn lại phải đăng nhập
                        .anyRequest().authenticated())

                // 3.1 Chuẩn hóa mã lỗi auth
     ...
     * 
     * Used for Registrar (admin) authentication
     */
    @Bean
    public AuthenticationProvider authenticationProvider() {
        DaoAuthenticationProvider authProvider = new DaoAuthenticationProvider(registrarUserDetailsService);
